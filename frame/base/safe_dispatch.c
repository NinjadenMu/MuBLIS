...
static bool context_is_valid(const mublis_context_t *context) {
  ...
  bool scontext_valid =
    scontext.gemm_ukr != NULL &&
    scontext.gemmtrsml_ukr != NULL &&
    scontext.gemmtrsmu_ukr != NULL &&
    scontext.mr > 0 &&
    scontext.nr > 0 &&
    scontext.mc > 0 &&
    scontext.kc > 0 &&
  ...
  bool dcontext_valid =
    dcontext.gemm_ukr != NULL &&
    dcontext.gemmtrsml_ukr != NULL &&
    dcontext.gemmtrsmu_ukr != NULL &&
    dcontext.mr > 0 &&
    dcontext.nr > 0 &&
    dcontext.mc > 0 &&
    dcontext.kc > 0 &&
